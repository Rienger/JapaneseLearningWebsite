...
function Adjective(){
    ...
    return <div className='inner-background'>
        ...
        <img onClick={start} src={chihiro} width='150px' height='auto' alt='chihiro'></img>
        <h1>2 TYPES OF ADJECTIVES</h1>
        <p className='adv-p'>You’ll need to learn a bit of Japanese grammar with these adjectives, but I’ve saved that for the end. For now, as you look over these words, pay attention to which ones end in い and which ones end in な. These are the two main types of Japanese adjectives, and we’ll discuss how to use each one.</p>
            ...
            <div className='adj-header'>
                <h1>な ADJECTIVE</h1>
                <h3>these are adjectives that ends with な when directly used to describe a noun</h3>
            </div>
            ...
            <div className='adj-header'>
                ...
                <h3>these are い ending adjectives but are considered as な-adjective -AND- there are adjectives that can be used as both い and な-adjective</h3>
