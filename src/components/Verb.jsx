...
function Verb(){
    ...
    return <div className='inner-background'>
        ...
        <header className='header'>
            ...
            <img onClick={start} src={chise} width='150px' height='auto' alt='gojo'></img>   
            <h1>3 TYPES OF VERBS</h1>
            <p className='adv-p'>Verbs are one of the most important parts of speech, and it’s said that verbs are the second most frequently used words (26%, next to nouns at 42%) among all other categories of words in daily Japanese conversations. </p>
        </header>
